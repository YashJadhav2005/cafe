  ...
  <div class="px-5 py-48 flex items-center backdrop-blur-sm justify-center flex-col">
    <div class="text-center rounded-3xl p-8 lg:w-2/3 w-full ">
      ...
      <div class="flex justify-center">
        <a href="mainmenu.php"><button class="ml-4 inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">Order Now</button></a>
      </div>
    </div>
  </div>
</section>
